...
def show_download_details_dialog(button, self, download_item):
    ...
    actionrow_download_type = Adw.ActionRow(title=_("Type"), tooltip_text=_("Type") + ": " + download_item.download_thread.download_details.get('type', ''))
    ...
    actionrow_download_status = Adw.ActionRow(title=_("Status"), tooltip_text=_("Status") + ": " + download_item.download_thread.download_details.get('status', ''))
    ...
    actionrow_download_percentage = Adw.ActionRow(title=_("Percentage Downloaded"), tooltip_text=_("Percentage Downloaded") + ": " + download_item.download_thread.download_details.get('percentage', ''))
    label_percentage = Gtk.Label(label=download_item.download_thread.download_details.get('percentage', ''))
    ...
    actionrow_download_remaining = Adw.ActionRow(title=_("Remaining"), tooltip_text=_("Remaining") + ": " + label_remaining.get_text())
    ...
    actionrow_download_download_speed = Adw.ActionRow(title=_("Download Speed"), tooltip_text=_("Download Speed") + ": " + label_download_speed.get_text())
