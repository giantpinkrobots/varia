...
cp varia.icns $MAC_DIR/Varia.app/Contents/Resources
...
mv dist/varia-tray/* $MAC_DIR/Varia.app/Contents/Resources/tray
cp tray.png $MAC_DIR/Varia.app/Contents/Resources/tray/_internal
cd $MAC_DIR/../src
pyinstaller --noconfirm varia.spec
mv dist/variamain/* $MAC_DIR/Varia.app/Contents/Resources
